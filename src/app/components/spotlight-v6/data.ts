...
export const mainSiteProviders: ClinicianV4[] = [
  ...
  // ── NEUROLOGY ──
  {
    ...
    hasSession: true,
    sessionDate: 'June 24',
    sessionTitle: 'Neurological Manifestations of Amyloidosis — Managing Amyloidosis PN',
    sessionDescription: 'Join us for an informative session where we’ll explore the neurological manifestations of amyloidosis, focusing on when treatment might be considered and what to expect. We’ll discuss how amyloidosis affects the peripheral nervous system, the process of evaluating and managing peripheral neuropathy, and the potential benefits and challenges of available therapies.',
    hasVideo: true,
    appointmentUrl: 'https://www.uchicagomedicine.org',
  },
  {
